...
describe('Test Rockets Component', () => {
  ...
  it('calls reserveRocket when reserve button is clicked', () => {
    ...
    expect(mockDispatch).toHaveBeenCalledWith({ type: 'rockets/makeReservations', payload: 'falcon9' });
  });
  it('calls cancelReservation when cancel button is clicked', () => {
    ...
    expect(mockDispatch).toHaveBeenCalledTimes(1);
    expect(mockDispatch).toHaveBeenCalledWith({ type: 'rockets/cancelReservations', payload: 'falcon1' });
  });
